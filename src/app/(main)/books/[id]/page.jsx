...
const bookDetailsPage = async({ params }) => {
     ...
     console.log(book)
     return (
          <div className='grid grid-cols-12 bg-white border p-5 my-10 max-w-7xl mx-auto border-gray-200 rounded-md gap-20 shadow-md'>
               <div className='bg-gray-100 p-10 rounded-lg justify-center items-center flex col-span-5'>
                    <Image src={book.image_url} alt='' className='h-100 w-70' height={500} width={100}></Image>
               </div>
               <div className='col-span-7'>
                    ...
                    <p className='text-gray-400 pt-3'>{book.description}</p>
                    ...
                    <div className='flex  mt-10'>
                         <Link href={'/'}><button className='btn btn-primary '>Borrow this book</button></Link>
                    </div>
               </div>
          </div>
     );
