    ...
    <div>
      <div>
        <div className="relative">
          <Image height={100} width={3000} className='w-full' src='/dark.png' alt=''></Image>
        </div>
        <div className="absolute text-white top-1/3 left-16">
          ...
          <h1 className="text-7xl pt-5 font-bold">Find Your <span className="bg-linear-to-r from-[#4F46E5] to-[#9b46e5] bg-clip-text text-transparent">Next</span> Read</h1>
          <p className="pt-3 max-w-140 text-white/80">Explore thousands of books, borrow your favorites, and embark on a journey of knowledge. Join a thriving community of lifelong learners and curious minds. </p>
