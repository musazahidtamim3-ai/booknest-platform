     ...
     return (
          <div className='max-w-7xl mx-auto my-10 px-5 lg:px-0'>
               ...
               <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5 my-5'>
                    <div className="flex items-center gap-6 bg-white border border-gray-200 shadow-md p-3 rounded-md hover:scale-102">
                    ...
                    <div className="flex items-center gap-5 bg-white border border-gray-200 shadow-md p-3 rounded-md hover:scale-102">
